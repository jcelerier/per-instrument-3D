...
The author used a dimension space representation (\ref{fig:classinstr}) to evaluate his instrument according to \cite{birnbaum2005towards}. We can see that the Drile environment fulfils two important aspects of this representation : 
\begin{enumerate}
\item The Feedback Modalities axis, especially with the 3D environnement and the Piivert controller, 
